...
const inputFieldStyle = tva({
  base: 'flex-1 text-typography-100 py-0 px-3 placeholder:text-typography-500 h-full ios:leading-[0px] web:cursor-text web:data-[disabled=true]:cursor-not-allowed',
