...
const TableHead = React.forwardRef<any, ITableHeadProps>(function TableHead(
  ...
  if (useRNView) {
    return <View ref={ref} className={tableHeadStyle({ class: className })} {...(props as any)} />;
  } else {
    return <Text ref={ref} className={tableHeadStyle({ class: className })} {...(props as any)} />;
  }
});
...
const TableData = React.forwardRef<any, ITableDataProps>(function TableData(
  ...
  if (useRNView) {
    return <View ref={ref} className={tableDataStyle({ class: className })} {...(props as any)} />;
  } else {
    return <Text ref={ref} className={tableDataStyle({ class: className })} {...(props as any)} />;
  }
});
