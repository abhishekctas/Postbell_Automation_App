...
import { getGeneralSettings, createOrUpdateGeneralSettings, GeneralSettings } from "./general-access.api";
        ...
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          {activeTab === 0 && (
            <Box style={styles.card}>
              <Heading size="md" className="text-typography-800 mb-4">Company Identity</Heading>
              <VStack space="md">
                <VStack space="xs">
          ...
          {activeTab === 1 && (
            <Box style={styles.card}>
              <Heading size="md" className="text-typography-800 mb-4">Social Links</Heading>
              <VStack space="md">
                <VStack space="xs">
          ...
          {activeTab === 2 && (
            <Box style={styles.card}>
              <Heading size="md" className="text-typography-800 mb-4">AI API Configuration</Heading>
              <VStack space="md">
                <VStack space="xs">
          ...
          {activeTab === 3 && (
            <Box style={styles.card}>
              <Heading size="md" className="text-typography-800 mb-4">Advanced Settings</Heading>
              <VStack space="md">
                <VStack space="xs">
          ...
          {activeTab === 4 && (
            <Box style={styles.card}>
              <Heading size="md" className="text-typography-800 mb-4">Footer Information</Heading>
              <VStack space="md">
                <VStack space="xs">
