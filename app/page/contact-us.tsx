        ...
        <VStack space="xs">
          <HStack className="justify-between items-start">
            <Box style={{ flex: 1, marginRight: 8 }}>
              <Text className="text-typography-800 font-bold text-base" numberOfLines={1}>
              ...
              <VStack space="md">
                ...
                <Box>
                  ...
                  <Box style={styles.messageBox}>
                    <Text className="text-typography-800 text-sm leading-5">{selectedRequest?.message}</Text>
                  </Box>
                </Box>
              </VStack>
            </ScrollView>
