...
const PLAN_TABLE_COLUMNS: HtmlTableColumn[] = [
  ...
  },
  {
    ...
    width: "90px",
    render: (v) => (
      <Text style={{ fontSize: 13, color: "#475569" }}>{v ?? 0}</Text>
    ),
  },
  {
    key: "posts_per_day",
  ...
  return (
    <Box style={{ position: "relative", width: 90, height: 60 }}>
      ...
      <Box style={{
        ...
        {/* Micro lines */}
        <Box style={{ height: 2, backgroundColor: "#e2e8f0", width: "80%", alignSelf: "center", marginBottom: 2 }} />
        ...
        {IconComponent && (
          <Box style={{ position: "absolute", left: 12, zIndex: 10, alignSelf: "center" }}>
            {typeof IconComponent === "string" ? (
              <Text style={{ fontSize: 14, fontWeight: "700", color: "#2563eb" }}>{IconComponent}</Text>
            ) : (
...
export default function SubscriptionPlansScreen() {
  ...
  const renderPagination = () => {
    ...
    return (
      <HStack className="justify-center items-center mt-4 mb-2" space="sm">
        <TouchableOpacity
        ...
        <Box className="px-5 pb-6">
          ...
          <HStack className="justify-between items-center">
            <VStack style={{ flex: 1, marginRight: 16 }}>
              <Heading size="xl" style={{ color: "#fff", fontWeight: "800", fontSize: 24, marginBottom: 4 }}>
                Subscription Plans
              </Heading>
            ...
            <Box className="px-5 pb-6">
              ...
              <HStack className="justify-between items-center">
                <VStack style={{ flex: 1, marginRight: 16 }}>
                  ...
                  <Text style={{ color: "rgba(255,255,255,0.85)", fontSize: 12 }}>
                    {editingPlan ? "Update your subscription plan details and preferences" : "Create a new subscription plan with specific rules"}
                  </Text>
                </VStack>
                <EditIllustration />
              </HStack>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 24 }}>
              <VStack space="lg">
                ...
                <HStack className="justify-between items-center bg-slate-50 p-4 rounded-xl border border-slate-100">
                  <VStack>
                    <Text style={{ fontSize: 13, fontWeight: "700", color: "#334155" }}>Popular (Monthly)</Text>
                ...
                <HStack className="justify-between items-center bg-slate-50 p-4 rounded-xl border border-slate-100">
                  <VStack>
                    <Text style={{ fontSize: 13, fontWeight: "700", color: "#334155" }}>Popular (Annual)</Text>
                ...
                <VStack space="xs">
                  ...
                  <HStack space="sm">
                    <TouchableOpacity
                      ...
                      onPress={() => setStatus(1)}
                    >
                      <Text style={{ fontSize: 13, fontWeight: "700", color: status === 1 ? "#047857" : "#475569" }}>Active</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                      style={{
                        flex: 1,
                      ...
                      onPress={() => setStatus(0)}
                    >
                      <Text style={{ fontSize: 13, fontWeight: "700", color: status === 0 ? "#b91c1c" : "#475569" }}>Inactive</Text>
                    </TouchableOpacity>
                  </HStack>
                </VStack>
              </VStack>
