    ...
    <VStack space="md" style={styles.container}>
      ...
      <View style={styles.bannerHeader}>
        <HStack space="md" style={{ alignItems: 'center' }}>
          ...
          <VStack style={{ flex: 1 }}>
            <Heading style={styles.bannerTitle}>Branding & Content Preferences</Heading>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.sectionSubtitle}>
          Used in flyers, poster borders, badges, and automated artwork overlays.
        </Text>
      ...
      {/* Voice & Language Card */}
      <View style={styles.card}>
        <Text style={styles.sectionHeading}>VOICE & LANGUAGE</Text>
        <Text style={styles.sectionSubtitle}>
          Controls the vocabulary style and output language generated by AI engines.
        </Text>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.sectionSubtitle}>
          These hashtags will be automatically appended to all your published posts.
        </Text>
