  ...
  return (
    <Box className="flex-1 bg-[#f8fafc]">
      ...
      >
        ...
        <Box style={styles.sectionCard}>
          ...
          <VStack space="md">
            ...
            <VStack space="xs">
              ...
              {video ? (
                <Box style={styles.mediaPreviewCard}>
                  <Box className="p-3 bg-slate-900 rounded-lg flex-row items-center justify-between">
            ...
            <VStack space="xs" style={{ flex: 1 }}>
              ...
              <HStack space="xs" className="mt-0.5">
                <TouchableOpacity
                  style={[
                    styles.statusToggle,
                    status === 1 && styles.statusToggleActive,
                  ]}
                  onPress={() => setStatus(1)}
                >
                  <Text
                ...
                <TouchableOpacity
                  style={[
                    styles.statusToggle,
                    status === 0 && styles.statusToggleInactive,
                  ]}
                  onPress={() => setStatus(0)}
                >
                  <Text
              ...
              <Box key={index} style={styles.pointCard}>
                <HStack className="justify-between items-center mb-3">
                  <HStack className="items-center space-x-2">
                    ...
                    <Text style={styles.pointHeaderLabel}>
        ...
        <VStack space="sm" className="mt-2 mb-4">
          <Button
