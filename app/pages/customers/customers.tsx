...
const CUSTOMER_TABLE_COLUMNS: HtmlTableColumn<Customer>[] = [
  ...
  },
  {
    ...
    render: (_v, row) => {
      ...
      const initials = name.split(" ").filter(Boolean).slice(0, 2).map((w) => w.charAt(0).toUpperCase()).join("") || "CU";
  ...
  },
  {
    ...
    label: "Contact",
    width: "130px",
    render: (v) => <Text style={{ fontSize: 13, color: "#475569" }} numberOfLines={1}>{v ? String(v) : "—"}</Text>,
  },
  {
    key: "gender",
    label: "Gender",
        ...
        >
          {customers.length === 0 ? (
            <Box className="items-center justify-center py-20">
              ...
              <Text className="text-typography-400 text-base mt-2">No customers found</Text>
            </Box>
          ) : (
            <HtmlTable
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{ maxHeight: 420 }}>
              <VStack space="md">
                  ...
                  <VStack space="xs" style={{ flex: 1 }}>
                    ...
                    <HStack space="xs">
                      <TouchableOpacity
                        ...
                        onPress={() => setGender(1)}
                      >
                        <Text style={[styles.genderText, gender === 1 && styles.genderTextActive]}>Male</Text>
                      </TouchableOpacity>
                      <TouchableOpacity
                        style={[styles.genderBtn, gender === 2 && styles.genderBtnActive]}
                        onPress={() => setGender(2)}
                      >
                        <Text style={[styles.genderText, gender === 2 && styles.genderTextActive]}>Female</Text>
                      </TouchableOpacity>
                    </HStack>
                  </VStack>
                  <VStack space="xs" style={{ flex: 1 }}>
                    ...
                    <HStack space="xs">
                      <TouchableOpacity
                        ...
                        onPress={() => setStatus(1)}
                      >
                        <Text style={[styles.genderText, status === 1 && styles.statusTextActive]}>Active</Text>
                      </TouchableOpacity>
                      <TouchableOpacity
                        style={[styles.genderBtn, status === 0 && styles.statusInactive]}
                        onPress={() => setStatus(0)}
                      >
                        <Text style={[styles.genderText, status === 0 && styles.statusTextInactive]}>Inactive</Text>
                      </TouchableOpacity>
                    </HStack>
                  </VStack>
                </HStack>
                ...
                <VStack space="xs">
                  ...
                  <TextInput style={styles.modalInput} value={dob} onChangeText={setDob} placeholder="1995-08-15" />
                </VStack>
              </VStack>
            </ScrollView>
